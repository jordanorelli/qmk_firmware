...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP_ALL(
		...
		LT(2, KC_ESC), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSLS, KC_GRV, KC_HOME,
		...
		MO(1), KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_RALT, KC_TRNS, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT),

    // Layer 1: RGB Controls
	KEYMAP_ALL(
		KC_TRNS, AG_SWAP, MAGIC_SWAP_LALT_LGUI, MAGIC_SWAP_RALT_RGUI, AG_NORM, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    // Layer 2: Mystery Layer (unreachable?)
	KEYMAP_ALL(
